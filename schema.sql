...
('Mesero','Gestión de pedidos por mesa'),
('Cajero','Control de pagos y facturación'),
('Cocina','Visualización de pedidos en cocina'),
...
('Bronce',5,1,0,'Descuento del 5%'),
('Plata',10,5,100,'Descuento del 10%'),
('Oro',15,15,300,'Descuento del 15%');
...
INSERT INTO mesas (mesa_numero,mesa_capacidad) VALUES
(1,4),(2,4),(3,6),(4,6),(5,2),(6,2),(7,8),(8,8);